...
import { FaAws, FaPython, FaChartLine, FaFacebook, FaScrewdriver } from "react-icons/fa"; // Using react-icons for skills

const skills = [
  { name: "AWS", icon: FaAws },
  { name: "Python", icon: FaPython },
  { name: "Meta Ads", icon: FaFacebook },
  { name: "Next.js", icon: FaChartLine }, // Placeholder for Next.js icon
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <section className="mb-20">
          ...
          <div className="relative overflow-hidden h-20 bg-gradient-to-r from-slate-950 via-slate-800 to-slate-950 rounded-xl border border-gray-700 shadow-lg">
            ...
            >
              {skills.concat(skills).map((skill, index) => ( // Duplicate skills for seamless loop
