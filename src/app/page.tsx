  ...
  return (
    <div className="min-h-screen bg-slate-950 text-gray-50 antialiased selection:bg-blue-600 selection:text-white">
      <div className="container mx-auto px-4 py-16">
        ...
        >
          <div className="mx-auto mb-6 w-36 h-36 rounded-full overflow-hidden border-4 border-blue-500 shadow-xl glow-effect animate-pulse-subtle relative"> {/* Added relative */} 
            <Image
              src="/avatar.png"
              alt="Amir B. Avatar"
              layout="fill"
